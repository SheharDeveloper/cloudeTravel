...
Route::get('/visa-services', [VisaController::class, 'index'])->name('visa-services');
Route::get('/visa-requirements', [VisaController::class, 'requirements'])->name('visa-requirements');
