...
export default function ClientEdit() {
    ...
    const existingFamily: FamilyMember[] = (client?.family_members || []).map((m: any) => ({
        name: m.name || '',
        relation: m.relation || '',
    ...
    const [data, setData] = useState({
        ...
        family_members: existingFamily.length > 0 ? existingFamily : [{ ...emptyFamilyMember }],
    });
    ...
    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        router.put(`/admin/clients/${client.uid}`, formData, {
            onSuccess: () => {
                                ...
                                {step === 3 && (
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6 mb-4">
                                            ...
                                            {passport?.front_image && <small className="text-muted">Current file on record — choose a new one to replace it.</small>}
                                        ...
                                        <div className="col-sm-6 mb-4">
                                            ...
                                            {passport?.back_image && <small className="text-muted">Current file on record — choose a new one to replace it.</small>}
