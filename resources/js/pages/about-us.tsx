        ...
        <>
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 20px' }}>
                ...
                <div style={{ marginBottom: '50px' }}>
                    <h2 style={{ fontSize: '28px', fontWeight: 700, color: '#003d82', marginBottom: '20px' }}>About Us</h2>
                    <p style={{ fontSize: '14px', color: '#666', lineHeight: 1.8, marginBottom: '15px' }}>
                        Cloud Travel Limited is a UK-based company (Company Registration No. 09677123) established in 2015 and trading under the registered brand Cloud Travel®. We are proud to be one of the UK's leading high street and online one-stop travel agencies, providing trusted and professional travel services to customers throughout the United Kingdom and worldwide.
                    </p>
                    <p style={{ fontSize: '14px', color: '#666', lineHeight: 1.8, marginBottom: '15px' }}>
                    ...
                    <p style={{ fontSize: '14px', color: '#666', lineHeight: 1.8 }}>
                        Since 2015, Cloud Travel® has built a reputation for excellent customer service, competitive prices, and complete travel solutions. Whether you are travelling for business, leisure, or family purposes, our experienced team is dedicated to making your journey simple, convenient, and memorable.
                    </p>
                </div>

                {/* Services Slider */}
                <div style={{ marginBottom: '50px' }}>
                    <h2 style={{ fontSize: '28px', fontWeight: 700, color: '#003d82', marginBottom: '30px' }}>Our Specialist Services</h2>
                    ...
                    <div style={{
                        ...
                        <div style={{ textAlign: 'center', maxWidth: '600px' }}>
                            <div style={{ fontSize: '24px', fontWeight: 700, color: '#003d82', marginBottom: '15px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '15px' }}>
                        {services.map((service, idx) => (
                            <div
                                key={idx}
                                style={{
                                    background: currentServiceIndex === idx ? '#0066cc' : '#fff',
