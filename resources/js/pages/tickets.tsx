    ...
    return (
        <>
            ...
            <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
                <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '32px', color: '#003d82', marginBottom: '20px' }}>Flight Tickets</h1>
                ...
                <div style={{ background: '#f0f0f0', padding: '30px', borderRadius: '8px', marginBottom: '40px' }}>
                    <h3 style={{ fontSize: '16px', fontWeight: 700, color: '#003d82', marginBottom: '20px' }}>Search Flights</h3>
                ...
                {/* Featured Deals */}
                <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#003d82', marginBottom: '20px' }}>Featured Deals</h3>
                        ...
                        <div key={item} style={{ background: '#fff', border: '1px solid #eee', borderRadius: '8px', padding: '20px' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
                                <div>
                                    ...
                                    <p style={{ fontSize: '14px', fontWeight: 700, color: '#003d82' }}>London (LHR)</p>
                                </div>
                                ...
                                <div style={{ textAlign: 'right' }}>
                                    ...
                                    <p style={{ fontSize: '14px', fontWeight: 700, color: '#003d82' }}>Dubai (DXB)</p>
                                </div>
                            </div>
                            <div style={{ borderTop: '1px solid #eee', paddingTop: '15px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <span style={{ fontSize: '16px', fontWeight: 700, color: '#ff6b35' }}>£{400 + item * 50}</span>
