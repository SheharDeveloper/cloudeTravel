                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', background: '#fff', padding: '30px', borderRadius: '8px', boxShadow: '0 8px 30px rgba(0,0,0,.15)' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '15px', alignItems: 'end' }}>
                        <div>
                            ...
                            <input type="text" placeholder="India" style={{ width: '100%', padding: '10px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '13px' }} />
                        </div>
                        <div>
                            ...
                            <input type="text" placeholder="Select country" style={{ width: '100%', padding: '10px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '13px' }} />
                        </div>
                        <div>
                        ...
                        <button style={{ background: '#ff6b35', color: '#fff', border: 'none', padding: '10px 30px', borderRadius: '4px', fontSize: '13px', fontWeight: 700, cursor: 'pointer' }}>Get Quote</button>
                    </div>
                </div>
            </div>
        </>
