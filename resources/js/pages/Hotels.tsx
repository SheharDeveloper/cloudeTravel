                ...
                <div style={{ maxWidth: '900px', margin: '0 auto', background: '#fff', padding: '30px', borderRadius: '8px', boxShadow: '0 8px 30px rgba(0,0,0,.15)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px', alignItems: 'end' }}>
                        <div>
                            ...
                            <input type="text" placeholder="Enter city" style={{ width: '100%', padding: '8px 10px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '12px' }} />
                        </div>
                        <div>
                            <label style={{ display: 'block', fontSize: '10px', color: '#999', marginBottom: '4px', fontWeight: 700, textTransform: 'uppercase' }}>Check-in</label>
                            <input type="date" style={{ width: '100%', padding: '8px 10px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '12px' }} />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="number" min="1" defaultValue="1" style={{ width: '100%', padding: '8px 10px', border: '1px solid #ddd', borderRadius: '4px', fontSize: '12px' }} />
                        </div>
                        <button style={{ background: '#6366f1', color: '#fff', border: 'none', padding: '8px 20px', borderRadius: '4px', fontSize: '12px', fontWeight: 700, cursor: 'pointer', height: '36px' }}>Search</button>
                    </div>
                </div>
            </div>
        </>
