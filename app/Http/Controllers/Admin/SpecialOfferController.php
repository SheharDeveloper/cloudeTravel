...
class SpecialOfferController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'flight_origin' => 'required_if:type,Flight|nullable|string|max:255',
            'flight_destination' => 'required_if:type,Flight|nullable|string|max:255',
            'hotel_name' => 'nullable|string|max:255',
            'hotel_star_rating' => 'nullable|integer|min:1|max:5',
            'hotel_country' => 'required_if:type,Hotel|nullable|string|max:255',
            'hotel_city' => 'required_if:type,Hotel|nullable|string|max:255',
            'visa_name' => 'nullable|string|max:255',
            'visa_destination_country' => 'required_if:type,Visa|nullable|string|max:255',
            'visa_passport_country' => 'required_if:type,Visa|nullable|string|max:255',
            'visa_type' => 'required_if:type,Visa|nullable|integer',
            'is_visa' => 'in:0,1',
            'package_country' => 'required_if:type,Package|nullable|string|max:255',
            'package_city' => 'nullable|string|max:255',
            'transport_name' => 'nullable|string|max:255',
            'transport_type' => 'nullable|string|max:255',
            'transport_origin' => 'required_if:type,Transportation|nullable|string|max:255',
            'transport_destination' => 'required_if:type,Transportation|nullable|string|max:255',
            'is_transport' => 'in:0,1',
