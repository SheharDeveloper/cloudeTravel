...
class StoreAgencyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'registration_number' => 'nullable|string|max:255|unique:agencies,registration_number',
            'gst_number' => 'nullable|string|max:255|unique:agencies,gst_number',
            'pan_number' => 'nullable|string|max:255|unique:agencies,pan_number',
